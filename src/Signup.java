...
String a=tf1.getText();
     ...
     String c=new String(pf2.getPassword());
     ...
     try
{
    ...
    PreparedStatement st= con.prepareStatement("insert into login values('"+a+"','"+b+"','"+d+"','"+f+"');");
    PreparedStatement st1= con.prepareStatement("insert into pin values('"+d+"');");
    st.executeUpdate();
    st1.executeUpdate();
